...
//for each object inside the parent Object
for (var prop in grungeAlbumsObject.albums){

 //for each object element inside the array of the parent Object
   for (var albumProp in grungeAlbumsObject.albums[prop]){
       console.log(albumProp + " : " + grungeAlbumsObject.albums[prop][albumProp]);
    }
}
